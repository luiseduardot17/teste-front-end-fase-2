...
const Sidebar = () => {
    return (
        <nav className="navbar bg-body border-3 border-bottom border-tertiary p-3 pb-2 mb-5">
            <div className="container-fluid">
                ...
                <div className="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" aria-expanded="false">
                    <div className="offcanvas-header border-bottom border-tertiary pb-2 pe-0">
